...
def make_graphified_models(model_name_list, num_layers=30):
    models = []
    for model_name in model_name_list:
        ...
        graph = TransformerEncoderGraph(deepcopy(model), modules=llama_modules, num_layers=num_layers)
...
if __name__ == '__main__':
    ...
    for num_layers in [1, 4, 8, 15, 25, 30]:
        graph1, graph2 = make_graphified_models(model_name_list, num_layers)
